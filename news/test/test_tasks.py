...
class NewsTasksTestCase(BaseTestCase):
    ...
    def test_filtering_news_with_user_filters(self):
        ...
        filter7.delete()
        self.assertEqual(News.objects.unread_for_user(self.user).count(), 211)
        filter1.delete()
        self.assertEqual(News.objects.unread_for_user(self.user).count(), 213)
        filter6.delete()
        self.assertEqual(News.objects.unread_for_user(self.user).count(), 217)
        filter3.delete()
        self.assertEqual(News.objects.unread_for_user(self.user).count(), 218)
        filter2.delete()
        self.assertEqual(News.objects.unread_for_user(self.user).count(), 222)
        filter4.delete()
        self.assertEqual(News.objects.unread_for_user(self.user).count(), 225)
        filter5.delete()
        self.assertEqual(News.objects.unread_for_user(self.user).count(), 246)
