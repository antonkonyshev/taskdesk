...
4. **[Vue.js](https://github.com/antonkonyshev/taskdesk/tree/master/news/vite)** and **TypeScript** for the implementation of web-applications.
5. **[Tailwind CSS](https://github.com/antonkonyshev/taskdesk/tree/master/news/vite/components)** for the graphical user iterface implementation.
6. **Vite** and **[Vitest](https://github.com/antonkonyshev/taskdesk/tree/master/news/vite/test)** for packaging of statics and assets and unit testing of the client-side logic.
